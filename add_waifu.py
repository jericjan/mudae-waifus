...
with open("content/posts/kur0.md", encoding="utf-8") as f:
    txt = f.readlines()
...
with open("content/posts/kur0.md", "w", encoding="utf-8", newline="") as f:
    f.write("".join(txt))

pyperclip.copy(smp)  # type: ignore
print(f"Your $smp command is: {smp}\nIt has been copied to the clipboard.\n")
input("Press enter to kill the hugo server and build the static site.\n")
